...
var MonthList = function (_Component) {
  ...
  function MonthList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
      ...
      if (!_this.monthHeights[index]) {
        ...
        // new method
        var totalWeeks = (0, _utils.getWeeksInMonthIncludingPartial)(month, year);
  ...
  MonthList.prototype.getDateOffset = function getDateOffset(date) {
    ...
    var weekOfMonth = (0, _utils.getWeekOfMonthFromDate)(offsetDate);
    var totalWeeks = (0, _utils.getWeeksInMonthIncludingPartial)(offsetDate.getMonth(), offsetDate.getFullYear());
    var totalWeeksAll = (0, _utils.getWeeksBetweenMonthIncludingPartial)(min, offsetDate);
