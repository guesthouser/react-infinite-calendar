...
var Month = function (_PureComponent) {
  ...
  Month.prototype.renderRows = function renderRows() {
    ...
    if (locale.hasOwnProperty("month_format")) {
      monthShort = (0, _format2.default)(monthDate, locale.month_format, { locale: locale.locale });
    }

    if (locale.hasOwnProperty("year_format")) {
      monthShort = monthShort + " " + (0, _format2.default)(monthDate, locale.year_format, { locale: locale.locale });
    }
    ...
    monthRows.unshift(_react2.default.createElement(
      'div',
      {
